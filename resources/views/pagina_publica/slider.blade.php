                                ...
                                <div class="timeline-item">
                                    <div class="row">
                                        ...
                                        <form id="formulario" enctype="multipart/form-data" accept-charset="UTF-8">
                                            ...
                                            <div class="col-lg-3">
                                                <select id="posicion_horizontal" name="posicion_horizontal" class="form-control m-b" required>
                                                    <option value="">Posición horizontal...</option>
                                            ...
                                            <div class="col-lg-3">
                                                <select id="posicion_vertical" name="posicion_vertical" class="form-control m-b" required>
                                                    <option value="">Posición vertical...</option>
...
@section('script') 
    ...
    <script type="text/javascript" src="{{asset('js/si/pagina_publica/slider.js')}}"></script>
